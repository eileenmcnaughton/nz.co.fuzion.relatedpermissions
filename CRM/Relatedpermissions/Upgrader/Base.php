 ...
 */
class CRM_Relatedpermissions_Upgrader_Base {

  /**
   * @var CRM_Relatedpermissions_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Relatedpermissions_Upgrader(
   ...
   *
   * ```
   * CRM_Relatedpermissions_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Relatedpermissions_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
